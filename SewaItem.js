      ...
      render(){
        ...
        return (
            ...
            <div className="card h-100" style={{ marginBottom: "10px"}}>
                <a href="#"><img className="card-img-top" src={'http://localhost/toko_online/public/images/' + item.images} style={{height: "300px"}}alt="" /></a>
                    <div className="card-body">
                        ...
                        <span className="card-text">
                            <small>Available Quantity: </small>{item.available_quality}
                        </span>
                        { item.available_quality > 0 ?
                        <div>
